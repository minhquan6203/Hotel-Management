...
create TABLE Customer ADD UNIQUE NONCLUSTERED 
(
	IDCard ASC
)
GO

create TABLE Parameter ADD UNIQUE NONCLUSTERED 
(
	Name ASC
)
GO

create TABLE Staff ADD UNIQUE NONCLUSTERED 
(
	IDCard ASC
)
GO
create TABLE Bill ADD  DEFAULT (getdate()) FOR DateOfcreate
GO
create TABLE Bill ADD  DEFAULT ((0)) FOR RoomPrice
GO
create TABLE Bill ADD  DEFAULT ((0)) FOR ServicePrice
GO
create TABLE Bill ADD  DEFAULT ((0)) FOR TotalPrice
GO
create TABLE Bill ADD  DEFAULT ((0)) FOR Discount
GO
create TABLE Bill ADD  CONSTRAINT DF__Bill__IDStatusBi__1DB06A4F  DEFAULT ((1)) FOR IDStatusBill
GO
create TABLE Bill ADD  DEFAULT ((0)) FOR Surcharge
GO
create TABLE BillDetails ADD  DEFAULT ((0)) FOR TotalPrice
GO
create TABLE Customer ADD  DEFAULT (N'No Name') FOR Name
GO
create TABLE CustomerType ADD  DEFAULT (N'No Name') FOR Name
GO
create TABLE Parameter ADD  DEFAULT (N'No Name') FOR Name
GO
create TABLE Parameter ADD  DEFAULT (getdate()) FOR DateModify
GO
create TABLE REPORT ADD  DEFAULT ((0)) FOR value
GO
create TABLE REPORT ADD  DEFAULT ((1)) FOR Month
GO
create TABLE REPORT ADD  DEFAULT ((1990)) FOR Year
GO
create TABLE Room ADD  DEFAULT (N'No Name') FOR Name
GO
create TABLE RoomType ADD  DEFAULT (N'No Name') FOR Name
GO
create TABLE Service ADD  DEFAULT (N'No Name') FOR Name
GO
create TABLE ServiceType ADD  DEFAULT (N'No Name') FOR Name
GO
create TABLE Staff ADD  DEFAULT (N'No Name') FOR DisplayName
GO
create TABLE StaffType ADD  DEFAULT (N'No Name') FOR Name
GO
create TABLE StatusBill ADD  DEFAULT (N'No Name') FOR Name
GO
create TABLE StatusRoom ADD  DEFAULT (N'No Name') FOR Name
GO
create TABLE ACCESS  WITH CHECK ADD FOREIGN KEY(IDJob)
REFERENCES JOB (ID)
GO
create TABLE ACCESS  WITH CHECK ADD FOREIGN KEY(IDStaffType)
REFERENCES StaffType (ID)
GO
create TABLE Bill  WITH CHECK ADD FOREIGN KEY(IDReceiveRoom)
REFERENCES ReceiveRoom (ID)
GO
create TABLE Bill  WITH CHECK ADD FOREIGN KEY(IDStatusBill)
REFERENCES StatusBill (ID)
GO
create TABLE Bill  WITH CHECK ADD FOREIGN KEY(StaffSetUp)
REFERENCES Staff (UserName)
GO
create TABLE BillDetails  WITH CHECK ADD FOREIGN KEY(IDBill)
REFERENCES Bill (ID)
GO
create TABLE BillDetails  WITH CHECK ADD FOREIGN KEY(IDService)
REFERENCES Service (ID)
GO
create TABLE BookRoom  WITH CHECK ADD FOREIGN KEY(IDCustomer)
REFERENCES Customer (ID)
GO
create TABLE BookRoom  WITH CHECK ADD FOREIGN KEY(IDRoomType)
REFERENCES RoomType (ID)
GO
create TABLE Customer  WITH CHECK ADD FOREIGN KEY(IDCustomerType)
REFERENCES CustomerType (ID)
GO
create TABLE ReceiveRoom  WITH CHECK ADD FOREIGN KEY(IDBookRoom)
REFERENCES BookRoom (ID)
GO
create TABLE ReceiveRoom  WITH CHECK ADD FOREIGN KEY(IDRoom)
REFERENCES Room (ID)
GO
create TABLE ReceiveRoomDetails  WITH CHECK ADD FOREIGN KEY(IDCustomerOther)
REFERENCES Customer (ID)
GO
create TABLE ReceiveRoomDetails  WITH CHECK ADD FOREIGN KEY(IDReceiveRoom)
REFERENCES ReceiveRoom (ID)
GO
create TABLE REPORT  WITH CHECK ADD FOREIGN KEY(idRoomType)
REFERENCES RoomType (ID)
GO
create TABLE Room  WITH CHECK ADD FOREIGN KEY(IDRoomType)
REFERENCES RoomType (ID)
GO
create TABLE Room  WITH CHECK ADD FOREIGN KEY(IDStatusRoom)
REFERENCES StatusRoom (ID)
GO
create TABLE Service  WITH CHECK ADD FOREIGN KEY(IDServiceType)
REFERENCES ServiceType (ID)
GO
create TABLE Staff  WITH CHECK ADD FOREIGN KEY(IDStaffType)
REFERENCES StaffType (ID)
GO
