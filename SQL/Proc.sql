...
@idCard nvarchar(100),@name nvarchar(100),@idCustomerType int,@sex nvarchar(100)
as
begin
	insert into Customer(IDCard,Name,IDCustomerType,Sex)
	values(@idCard,@name,@idCustomerType,@sex)
end
