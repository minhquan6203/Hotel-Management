...
namespace HotelManager.DAO
{
    public class RoomDAO
    {
        ...
        public int GetPeoples(int idBill)
        {
            ...
            return (int)DataProvider.Instance.ExecuteScalar(query, new object[] { idBill });
        }
        ...
        public bool UpdateStatusRoom1(int idRoom)
        {
            string query = "USP_UpdateStatusRoom1 @idRoom";
            return DataProvider.Instance.ExecuteNoneQuery(query, new object[] { idRoom }) > 0;
        }
