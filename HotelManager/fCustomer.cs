...
namespace HotelManager
{
    public partial class fCustomer : Form
    {
        ...
        {
            InitializeComponent();
            cbCustomerSearch.SelectedIndex = 2;
        ...
        {
            if (!CheckFillInText(new Control[] { txbFullName, txbIDCard, comboBoxCustomerType, comboBoxSex}))
            {
        ...
        private void cbCustomerSearch_SelectedIndexChanged(object sender, EventArgs e)
        {
